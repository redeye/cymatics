...
- **LFO Pitch Modulation**: Optional low-frequency oscillator lets you add vibrato. Control the speed in seconds and toggle it on or off.
- **Custom Notes**: Save your current frequency as a new note. Custom notes appear in a separate row and persist between sessions.
- **Smoothed Microphone Detection**: Pitch from the microphone is detected with an autocorrelation algorithm for less jitter.
...
10. **Toggle the LFO**: Switch the low-frequency oscillator on or off and use the slider to control its period in seconds.
11. **Save Custom Note**: Store your current frequency as a new note. Saved notes appear in an extra row of buttons.
12. **Responsive Canvas**: The canvas automatically adjusts to the screen size, ensuring optimal viewing on all devices.
...
- **Local Storage**: Your last used frequency, color, waveform and any custom notes are saved between sessions.
